...
export const StepEditor = forwardRef<HTMLDivElement, { parentHops: Hop[]; hop: Hop; title: string; children: ReactNode; pipeline?: ReactNode }>(
	function StepEdtitor({ parentHops, hop, title, children, pipeline }, ref) {
